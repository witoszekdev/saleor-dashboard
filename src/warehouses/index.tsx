...
import { WarehouseDetails as WarehouseDetailsComponent } from "./views/WarehouseDetails/WarehouseDetails";
import { WarehouseList as WarehouseListComponent } from "./views/WarehouseList/WarehouseList";
